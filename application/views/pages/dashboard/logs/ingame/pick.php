...
<form class="form form-inline" action="dashboard/logs/pick" method="GET">
    ...
    <select class="form-control" name="field">
        ...
        <option value="nameid"<?php if(isset($_GET['field']) AND 'nameid' == $_GET['field']){echo ' selected';} ?>>Item ID</option>
    ...
    <select class="form-control" name="sort">
        <optgroup label="Sort By">
            ...
            <option value="nameid"<?php if(isset($_GET['sort']) AND 'nameid' == $_GET['sort']){echo ' selected';} ?>>Item ID</option>
...
<table class="table table-striped">
    <thead>
        <tr>
            ...
            <th class="text-right">Refine</th>
            <th class="text-right">Card 1</th>
            <th class="text-right">Card 2</th>
            <th class="text-right">Card 3</th>
            <th class="text-right">Card 4</th>
            <th>Map</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right"><?php echo $log->nameid; ?></td>
            <td class="text-right"><?php echo $log->amount; ?></td>
            <td class="text-right"><?php echo $log->refine; ?></td>
            <td class="text-right"><?php echo $log->card0; ?></td>
            <td class="text-right"><?php echo $log->card1; ?></td>
            <td class="text-right"><?php echo $log->card2; ?></td>
            <td class="text-right"><?php echo $log->card3; ?></td>
            <td><?php echo $log->map; ?></td>
        </tr>
        <?php endforeach; else: ?>
        <tr>
            <td colspan="11" style="font-style: italic; color: #ccc;" class="center">No result found!</td>
        </tr>
        <?php endif; ?>
    </tbody>
</table>
