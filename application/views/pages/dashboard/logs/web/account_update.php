...
<form class="form form-inline" action="dashboard/logs/acc-update" method="GET">
    ...
    <select class="form-control" name="field">
        <option value="user1"<?php if(isset($_GET['field']) AND 'user1' == $_GET['field']){echo ' selected';} ?>>Account ID/IP</option>
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="vertical-align: top !important;" class="center"><?php echo $log->user1; ?></td>
