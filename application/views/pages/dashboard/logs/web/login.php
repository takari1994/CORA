...
<form class="form form-inline" action="dashboard/logs/web-login" method="GET">
    ...
    <select class="form-control" name="sort">
        <optgroup label="Sort By">
            ...
            <option value="note"<?php if(isset($_GET['sort']) AND 'note' == $_GET['sort']){echo ' selected';} ?>>Type</option>
        </optgroup>
    </select>
