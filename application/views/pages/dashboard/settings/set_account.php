    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                ...
                <span class="help-block justify">Use regex as value. It is <strong>crucial</strong> that the same setting in your server match the value specified above. Click <a href="http://youtu.be/3o0i1b5TOLA?t=1s">here</a> for regex tutorial.</span>
            </div>
            <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    ...
                    <span class="help-block inline"><strong>Note:</strong> Existing accounts will not be affected.</span>
                </label>
            </div>
            -->
            <!--
            <div class="checkbox">
                <label>
                    <input type="checkbox" name="req_capt_log" value="1"<?php if(1 == $settings[0]->req_capt_log){ echo " checked"; } ?> /> Require captcha on login
                </label>
