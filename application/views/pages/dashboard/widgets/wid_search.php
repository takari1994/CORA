<form id="wid-form" name="wid-search-form" method="post">
...
<div class="right">
    <button class="btn btn-primary" id="wid_search_btn" name="submit">Save Changes</button>
</div>
<script type="text/javascript">
    $('#wid_search_btn').click(function() {
