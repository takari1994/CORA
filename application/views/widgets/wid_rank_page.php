<div id="wid-<?php echo $wuid; ?>" class="panel panel-primary widget wid-rank">
    ...
    <div class="panel-body" role="tabpanel">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#wid-<?php echo $wuid; ?>-pl-rank" data-toggle="tab">Player</a></li>
